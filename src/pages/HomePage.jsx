              ...
              <div className={"w-full flex items-start"}>
                ...
                >
                  ...
                  >
                    ...
                    <IconButton
                      onClick={() => {
                        window.location.href = `https://techutsav2024.blob.core.windows.net/eceimages/${currentData.uniqueName}.jpg`;
                      }}
                    >
                      <CloudDownloadIcon />
                    </IconButton>
                ...
                >
                  <img
                    src={`https://techutsav2024.blob.core.windows.net/eceimages/${currentData.uniqueName}.jpg`}
                    alt=""
                  />
                </div>
              </div>
